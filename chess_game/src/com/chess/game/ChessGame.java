...
public class ChessGame implements Observer {
    ...
    private JPanel createPlayerPanel(Player player) {
        ...
        turnIndicator.setFont(new Font("Segoe UI Symbol", Font.PLAIN, 7));
    ...
    private void updateCapturedPiecesPanel(JPanel panel, List<Piece> capturedPieces) {
        ...
        JPanel currentRow = new JPanel(new FlowLayout(FlowLayout.CENTER, 10, 10));
        ...
        for (Piece piece : capturedPieces) {
            ...
            pieceContainer.setPreferredSize(new Dimension(80, 80)); // Make it the same size as board squares
